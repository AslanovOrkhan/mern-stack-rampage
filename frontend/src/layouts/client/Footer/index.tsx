...
const Footer = () => {
  ...
  return (
    <footer className="bg-black">
      <div
        className="py-6 lg:px-10 px-2 lg:gap-0 gap-6 grid lg:grid-cols-2 grid-cols-1"
        style={{
          background:
            "linear-gradient(331deg, rgba(0,0,0,0.95) 71%, rgba(255,0,0,0.95) 100%)",
        }}
      >
        <div className="grid lg:grid-cols-2 grid-cols-1 lg:border-r lg:border   border-none border-[#525252]">
          <div className="flex flex-col items-start justify-start lg:gap-32 gap-6">
        ...
        <div className="overflow-hidden">
          <div className="lg:w-[60%] w-[100%] h-full m-auto flex flex-col justify-between">
            ...
            <div data-aos="fade-left" className="flex items-center justify-start gap-6 lg:mt-0 mt-6">
      ...
      <div className="bg-[#171717] py-10 lg:px-10 px-2 flex lg:flex-row flex-col lg:gap-0 gap-6 items-center justify-between">
          <span className="text-white text-xl">© 2025 Rampage. Powered by Shopify</span>
          <ul className="flex flex-wrap items-center lg:justify-start justify-center lg:gap-6 gap-2">
            <li>  
              <a href="#" className="text-white text-center">Terms of service</a>
            </li>
            <li>  
              <a href="#" className="text-white text-center">Contact information</a>
            </li>
            <li>  
              <a href="#" className="text-white text-center">Privacy policy</a>
            </li>
            <li>  
              <a href="#" className="text-white text-center">Refund policy</a>
            </li>
          </ul>        
      </div>
    </footer>
