...
const CreateCategoryModal: React.FC<CreateCategoryModalProps> = ({ onClose, onSuccess }) => {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    if (!imageFile) {
      toast.error("Category image must be selected.");
      return;
    }
    setLoading(true);
    ...
    try {
      ...
      toast.error(err?.message || "Category not created.");
    } finally {
      setLoading(false);
    }
  };
